...
Despesas %>%  group_by(ano) %>% summarise(count=n()) -Despesas[Despesas$Valor<1000,] %>%  group_by(ano) %>% summarise(count=n()) 
Despesas %>%  group_by(ano) %>% summarise(count=n())


sort(Despesas$Valor[Despesas$Valor>1000])
length(Despesas$Valor[Despesas$Valor <1000])
